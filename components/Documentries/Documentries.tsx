  ...
  return (
    <div className="py-5 px-2 mx-auto overflow-hidden sm:px:2 container">
      ...
      <div className="bg-playerbg px-3 py-10 ml-2 mr-2 mt-10 mb-10">
        ...
        <div className="bg-playerbg px-3 py-10 ml-2 mr-2 mt-10 mb-10">
          <Image src="/../public/image14.png" width={450} height={100} alt="alt" className="mx-auto"/>
          <p className="mt-2 text-xl font-bold">Harnesing The Elements</p>
        </div>
        <div className="bg-playerbg px-3 py-10 ml-2 mr-2 mt-10 mb-10">
          <Image src="/../public/image15.png" width={450} height={100} alt="alt"className="mx-auto" />
