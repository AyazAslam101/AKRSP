              ...
              return (
                <div key={index} className="text-center mb-16">
                  ...
                  <p className="text-base font-weight font-normal tracking-wide leading-7 container lg:px-20 text-center mt-4">
                    ...
                    khyber pakhtunkhwa. to improve the socio-economic conditions
                    of young men and women in gilgit baltistan and chitral 9GBC
                  </p>
                </div>
              );
            })}
              ...
              return (
                <div key={index} className="text-center mb-16">
                  ...
                  <p className="text-base font-weight font-normal tracking-wide leading-7 container lg:px-20 text-center mt-4">
                    ...
                    Development and Cooperation (SDC) Project Duration: 3 Years
                    (August 2014 - November 2017) Geographic Focus: All 24 Union
                    Councils of Chitral District To provide the communities with
                    access to clean and renewable energy for domestic and
                    commercial purposes To promote productive use of energy for
                    generating income opportunities for the rural households
                  </p>
                </div>
              );
            })}
